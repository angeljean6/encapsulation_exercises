...
class PetRegistryGUI:
    def __init__(self, window: tk.Tk):
        ...
        self.window.configure(bg="#0B0F19")  # Cyberpunk deep blue/black

        # Instantiate our encapsulated Pet object
        self.active_pet = Pet()
    ...
    def process_pet_data(self) -> None:
        ...
        # Validation handling for structural Integer validation crash protection
        try:
        ...
        # --- THE ENCAPSULATION PROOF ---
        # Data is fed strictly via mutator methods
        self.active_pet.set_name(raw_name)
        self.active_pet.set_animal_type(raw_type)
        self.active_pet.set_age(raw_age)

        # Visual layout is built safely via accessor methods
        ...
        # Highlight success via color shifting
